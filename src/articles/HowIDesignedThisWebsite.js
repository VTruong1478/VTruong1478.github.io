  ...
  return (
    <article className="bg-background min-h-screen py-16 px-6 text-text scroll-mt-16">
      <div className="max-w-3xl mx-auto">
        ...
        >
          <p>
            When I set out to build my personal website, I knew I didn’t want it
            to feel like just another static resume. I wanted it to reflect my
            personality while still being easy and enjoyable to use. That’s why
            I turned to <strong>Human-Centered Design (HCD)</strong>, an
            approach that puts <strong>people</strong> at the core of every
            design decision. Instead of starting with “what do I want to show?”
          ...
          <p>
            ...
            frustrated trying to keep it all together. That experience taught me
            a simple lesson:{" "}
            <strong>
              set the foundation first, then build everything else on top of it.
            </strong>{" "}
            I carried that same approach into my own site, making sure every
            choice, from color to typography to accessibility, felt intentional
            and consistent.
          </p>

          <h2>Knowing my Audience</h2>
          <p>
            When I began planning my site, I thought about who would actually be
            visiting my site. For the most part, it’s recruiters, potential
            teammates, or collaborators. It’s people who might only spend a few
            minutes scrolling before moving on. With that in mind, I designed
            the site to be <strong>clear and easy to navigate</strong>, putting
            the most important information right up front. My goal was to make
            their experience smooth, intuitive, and leave them with a{" "}
          ...
          <p>
            ...
            indicates that{" "}
            <strong>colors significantly influence user perception.</strong> For
            instance, blue is often associated with trust and professionalism,
            making it a popular choice for corporate and tech websites.
            Additionally, cool-toned palettes featuring blues, greens, and
            purples are known to create soothing and calming effects, which can{" "}
            <strong>enhance user experience by reducing cognitive load.</strong>
          </p>

          <p>
            To ensure readability and accessibility, I selected colors that meet
            WCAG contrast standards. Tools like{" "}
            ...
            website that not only reflects my personal brand but also provides a{" "}
            <strong>positive and engaging experience for visitors.</strong>
          </p>
          ...
          <p>
            ...
            which leaves people out of the experience. I wanted inclusiveness to
            be part of the foundation. That meant choosing text sizes and
          ...
          <ul>
            <li>
              <strong>Minimalist layout</strong> to let the content speak louder
              than the decoration
            </li>
            <li>
          ...
          <p>
            ...
            <strong>positive impression and an easy experience</strong>. For me,
            that’s what Human-Centered Design is all about. It’s less about
            perfect intentions and more about empathy.
          </p>
        </div>
      </div>
    </article>
